...
const navbaricon = () => {
  ...
  const getPrimaryColor = (shade: string | number) => `var(--primary-${shade})`;
  const getNeutralColor = (shade: string | number) => `var(--neutral-${shade})`;
  const getSecondaryColor = (shade: string | number) => `var(--secondary-${shade})`;
